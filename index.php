...
<meta name="keywords" content="anibuzz,アニメ,話題,ランキング" />
<meta name="description" content="アニメ新番組の話題ランキング" />
<meta http-equiv="content-Style-type" content="text/css" />
<meta http-equiv="content-Script-type" content="text/javascript" />
<title>anibuzz - アニメ新番組話題ランキング</title>
...
<a href="http://tiger4th.com/anibuzz/"><img src='./image/anibuzz.png' alt='anibuzz' height=70></a>
</div>

<div id="ad">
<!-- admax -->
<script type="text/javascript" src="http://adm.shinobi.jp/s/d7a1a7f5a91f15218346775c935e0f4c"></script>
<!-- admax -->
</div>
...
<tr>
<td>ニコニコ</td>
<td>ニコニコ動画のタグ検索で作品のタグによって検索したヒット数<br />
リンク先はニコニコ動画タグ検索結果</td>
</tr>
<tr>
<td>pixiv</td>
<td>pixivで作品のタグによって検索したヒット数<br />
リンク先はpixiv検索結果</td>
</tr>
<tr>
<td>スコア</td>
...
<div id="right"><a href="http://tiger4th.com/anibuzz/?cour=<?php echo $cour; ?>">元のページに戻る</a></div>
<?php }else{ ?>
<table class="list">
<tr>
<th>順位</th>
...
<th><a href="http://www.nicovideo.jp/video_top/" target="_brank"><span class="mdw">ニコニコ</span></a></th>
<th><a href="http://www.pixiv.net/" target="_brank"><span class="mdw">pixiv</span></a></th>
<th>スコア</th>
</tr>
<?php
$i=1;
...
$tag = rawurlencode(str_replace(" -", " ", $anime[$key][2]));
$url_t = rawurlencode(str_replace("http://", "", $anime[$key][1]));
?>
<tr onmouseover="style.background='#daedf5'" onmouseout="style.background='#ffffff'">
<td align="right" <?php if($anime[$key]["o"] == 1){ ?>style="border-left: #6699cc 2px solid"<?php } ?>><?php echo $i; ?></td>
...
<td align="right"><a href="http://blog.search.yahoo.co.jp/search?p=<?php echo $url_t; ?>" target="_brank"><?php echo $data[$key]["b"]; ?></a></td>
<td align="right"><a href="http://www.google.co.jp/search?q=site%3A%222ch.net%22+%22<?php echo $url_t; ?>%22" target="_brank"><?php echo $data[$key]["2"]; ?></a></td>
<td align="right"><a href="http://www.nicovideo.jp/tag/<?php echo $tag; ?>" target="_brank"><span class="black"><?php echo $data[$key]["n"]; ?></span></a></td>
<td align="right"><a href="http://www.pixiv.net/search.php?s_mode=s_tag&word=<?php echo $tag; ?>" target="_brank"><span class="black"><?php echo $data[$key]["p"]; ?></span></a></td>
...
<td>&nbsp;</td>
<td><a href="http://b.hatena.ne.jp/entry/http://tiger4th.com/anibuzz/" class="hatena-bookmark-button" data-hatena-bookmark-title="anibuzz" data-hatena-bookmark-layout="standard" title="このエントリーをはてなブックマークに追加"><img src="http://b.st-hatena.com/images/entry-button/button-only.gif" alt="このエントリーをはてなブックマークに追加" width="20" height="20" style="border: none;" /></a><script type="text/javascript" src="http://b.st-hatena.com/js/bookmark_button.js" charset="utf-8" async="async"></script></td>
<td>&nbsp;</td>
<td><iframe src="http://www.facebook.com/plugins/like.php?href=http://tiger4th.com/anibuzz/&amp;send=false&amp;layout=button_count&amp;width=100&amp;show_faces=true&amp;action=like&amp;colorscheme=light&amp;font&amp;height=21" scrolling="no" frameborder="0" style="border:none; overflow:hidden; width:100px; height:21px;" allowTransparency="true"></iframe></td>
...
<br />
<p class="hr"></p>
<?php if($cour != "201010"){echo '<a href="?cour=201010">';} ?>2010秋<?php if($cour != "201010"){echo '</a>';} ?>
　<?php if($cour != "201007"){echo '<a href="?cour=201007">';} ?>2010夏<?php if($cour != "201007"){echo '</a>';} ?>
<br />
<?php if($cour != "201004"){echo '<a href="?cour=201004">';} ?>2010春<?php if($cour != "201004"){echo '</a>';} ?>
　<?php if($cour != "201001"){echo '<a href="?cour=201001">';} ?>2010冬<?php if($cour != "201001"){echo '</a>';} ?>
<br />
</div>
</div>
...
<div class="box" align="center">
<a href="http://tiger4th.com/drabuzz/"><img src="./image/drabuzz.png" width="170" alt="drabuzz" /></a>
</div>
<div class="box" align="center">
